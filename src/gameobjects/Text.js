 ...
 */
Phaser.Text.prototype.setShadow = function(
    x,
    y,
    color,
    blur,
            ...
            if (Array.isArray(tabs)) {
                ...
                for (var c = 0; c < line.length; c++) {
                    ...
                    if (
                        ...
                        section = Math.ceil(
                            this.context.measureText(line[c]).width
                        );
                    }
                ...
                for (var c = 0; c < line.length; c++) {
                    ...
                    var diff =
                        this.game.math.snapToCeil(lineWidth, tabs) - lineWidth;
...
Phaser.Text.prototype.advancedWordWrap = function(text) {
    ...
    // (2) split into lines
    var lines = text.replace(/ +/gi, " ").split(/\r?\n/gi);
...
Phaser.Text.fontPropertiesContext = Phaser.Text.fontPropertiesCanvas.getContext(
    "2d"
);
